...
class UserEntryFormPage extends StatefulWidget {
  ...
  UserEntryFormPage({super.key,  Map<String,dynamic>? userDetails}){
...
class _UserEntryFormPageState extends State<UserEntryFormPage> {
  ...
  void initState() {
    ...
    if(widget.userDetails != null){
      ...
      phoneController.text=widget.userDetails![PHONE].toString();

    }
    selectedCity = widget.userDetails != null ?
        cities[findIndex(cities, widget.userDetails![CITY])]
        : cities[0];
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.userDetails==null ? 'REGISTATION' : 'EDIT USER',
          style: TextStyle(
            color: Colors.white,
          ),
        ),
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(
                  widget.userDetails==null ? 'SUBMIT' : 'EDIT',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 25,
                  ),
